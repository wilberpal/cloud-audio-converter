...
var responseTimeDistributionInfos = {
        data: {"result": {"minY": 1044.0, "minX": 0.0, "maxY": 1044.0, "series": [{"data": [[0.0, 1044.0]], "isOverall": false, "label": "Crear Tarea", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 100, "maxX": 4.9E-324, "title": "Response Time Distribution"}},
        getOptions: function() {
...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 3.0, "minX": 1.66796508E12, "maxY": 27.636000000000006, "series": [{"data": [[1.66796508E12, 17.7389705882353], [1.6679658E12, 22.631274131274136], [1.66796514E12, 27.636000000000006], [1.66796574E12, 3.0]], "isOverall": false, "label": "Thread Group", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.6679658E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 1.2352941176470593, "minX": 1.0, "maxY": 11.0, "series": [{"data": [[2.0, 11.0], [3.0, 1.6666666666666667], [4.0, 1.5], [5.0, 1.5], [6.0, 1.5], [7.0, 1.6666666666666667], [8.0, 1.5714285714285716], [9.0, 1.8125000000000002], [10.0, 1.833333333333333], [11.0, 1.7499999999999998], [12.0, 1.5499999999999996], [13.0, 1.2608695652173916], [14.0, 1.565217391304348], [15.0, 1.384615384615385], [16.0, 1.285714285714286], [1.0, 1.5], [17.0, 1.4000000000000001], [18.0, 1.4], [19.0, 1.2500000000000007], [20.0, 1.2352941176470593], [21.0, 1.3333333333333335], [22.0, 1.3157894736842106], [23.0, 1.3250000000000004], [24.0, 1.4000000000000004], [25.0, 1.3095238095238098], [26.0, 1.3636363636363635], [27.0, 1.304347826086957], [28.0, 1.3125], [29.0, 1.3800000000000003], [30.0, 1.248299319727891]], "isOverall": false, "label": "Crear Tarea", "isController": false}, {"data": [[22.479885057471257, 1.391762452107279]], "isOverall": false, "label": "Crear Tarea-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 30.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 0.0, "minX": 1.66796508E12, "maxY": 11793.133333333333, "series": [{"data": [[1.66796508E12, 6283.2], [1.6679658E12, 11793.133333333333], [1.66796514E12, 5775.0], [1.66796574E12, 91.06666666666666]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.66796508E12, 0.0], [1.6679658E12, 0.0], [1.66796514E12, 0.0], [1.66796574E12, 0.0]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.6679658E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 1.2840000000000003, "minX": 1.66796508E12, "maxY": 8.5, "series": [{"data": [[1.66796508E12, 1.4742647058823526], [1.6679658E12, 1.3455598455598445], [1.66796514E12, 1.2840000000000003], [1.66796574E12, 8.5]], "isOverall": false, "label": "Crear Tarea", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.6679658E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.66796508E12, "maxY": 4.9E-324, "series": [{"data": [[1.66796508E12, 0.0], [1.6679658E12, 0.0], [1.66796514E12, 0.0], [1.66796574E12, 0.0]], "isOverall": false, "label": "Crear Tarea", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.6679658E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.66796508E12, "maxY": 4.9E-324, "series": [{"data": [[1.66796508E12, 0.0], [1.6679658E12, 0.0], [1.66796514E12, 0.0], [1.66796574E12, 0.0]], "isOverall": false, "label": "Crear Tarea", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.6679658E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 1.0, "minX": 1.0, "maxY": 2.0, "series": [{"data": [[2.0, 1.5], [8.0, 1.0], [9.0, 1.0], [10.0, 1.0], [11.0, 1.0], [3.0, 2.0], [12.0, 1.0], [13.0, 1.0], [14.0, 1.0], [15.0, 1.0], [1.0, 2.0], [4.0, 2.0], [16.0, 1.0], [5.0, 1.0], [6.0, 1.0], [7.0, 1.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 16.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 0.06666666666666667, "minX": 1.66796508E12, "maxY": 8.633333333333333, "series": [{"data": [[1.66796508E12, 4.533333333333333], [1.6679658E12, 8.633333333333333], [1.66796514E12, 4.166666666666667], [1.66796574E12, 0.06666666666666667]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.6679658E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 0.06666666666666667, "minX": 1.66796508E12, "maxY": 8.633333333333333, "series": [{"data": [[1.66796508E12, 4.533333333333333], [1.6679658E12, 8.633333333333333], [1.66796514E12, 4.166666666666667], [1.66796574E12, 0.06666666666666667]], "isOverall": false, "label": "Non HTTP response code: java.io.FileNotFoundException", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.6679658E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 0.06666666666666667, "minX": 1.66796508E12, "maxY": 8.633333333333333, "series": [{"data": [[1.66796508E12, 4.533333333333333], [1.6679658E12, 8.633333333333333], [1.66796514E12, 4.166666666666667], [1.66796574E12, 0.06666666666666667]], "isOverall": false, "label": "Crear Tarea-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.6679658E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var totalTPSInfos = {
        data: {"result": {"minY": 0.06666666666666667, "minX": 1.66796508E12, "maxY": 8.633333333333333, "series": [{"data": [], "isOverall": false, "label": "Transaction-success", "isController": false}, {"data": [[1.66796508E12, 4.533333333333333], [1.6679658E12, 8.633333333333333], [1.66796514E12, 4.166666666666667], [1.66796574E12, 0.06666666666666667]], "isOverall": false, "label": "Transaction-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.6679658E12, "title": "Total Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
